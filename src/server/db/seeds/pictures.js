    ...
    .then(function () {
      return Promise.all([
        ...
        knex('pictures').insert({project: 'Galvanize', room: 'Classroom', pic_url: 'galvanize/IMG_20161130_104026', orientation: 'east'}),
          // Gym
        knex('pictures').insert({project: 'Galvanize', room: 'Gym', pic_url: 'galvanize/IMG_20161202_093148', orientation: 'south'}),
        knex('pictures').insert({project: 'Galvanize', room: 'Gym', pic_url: 'galvanize/IMG_20161202_093158', orientation: 'east'}),
        knex('pictures').insert({project: 'Galvanize', room: 'Gym', pic_url: 'galvanize/IMG_20161202_093205', orientation: 'north'}),
        knex('pictures').insert({project: 'Galvanize', room: 'Gym', pic_url: 'galvanize/IMG_20161202_093224', orientation: 'west'}),
        // hospital
